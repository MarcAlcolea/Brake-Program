...
from .panels.stopping_panel import StoppingPanel
...
class MainWindow(QMainWindow):
    ...
    def _simulator_page(self) -> QWidget:
        ...
        self._stopping = StoppingPanel(self.controller)
        ...
        rv.addWidget(CollapsibleSection("Stopping distance & time", self._stopping, expanded=True))
